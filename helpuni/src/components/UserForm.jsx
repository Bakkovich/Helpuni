...
function BtnLogout() {
    async function Logout() {
        chrome.runtime.sendMessage(JSON.stringify({"type": "logout"}), (response) => {
  ...
  function BtnSettings() {
    ...
    return (
        <a id="settings" className="SettingsIcon" style={{ cursor:'pointer' }} onClick={Settings}>
            <svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px" viewBox="0 0 24 24">
...
function AccountIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px" viewBox="0 0 24 24" className="AccountIcon">
...
export default function UserForm({username}){
    return (
